...
const NavBar = ({ activePage }) => {
	...
	return (
		<nav className='fixed top-0 z-50 w-full bg-white shadow-xl'>
			<div className='flex h-20 w-full flex-row items-center justify-between px-4 md:px-16'>
				{/* Logo */}
				<div className='flex flex-row space-x-1'>
					...
					<div className='flex flex-col justify-center space-y-0'>
						...
						<p className='text-xs'>Kec. Tegallang, Kab. Gianyar, Prov. Bali</p>
					</div>
				</div>
			...
			{menuOpen && (
				<div className='flex flex-col space-y-2 bg-white px-4 py-2 md:hidden'>
					<a
						className={getLinkClass('Profil Desa')}
						href='/profil-desa'
